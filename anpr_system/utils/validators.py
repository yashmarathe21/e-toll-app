...
def is_number_plate_text_correct(number_plate_text: Optional[str]) -> bool:
    ...
    are_number_plate_total_characters_correct = total_characters == 3 or total_characters == 4
    
    return is_state_rto_code_correct and are_number_plate_total_digits_correct and are_number_plate_total_characters_correct